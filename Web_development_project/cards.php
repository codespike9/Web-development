...
<html lang="pt-BR">
  <head>
    <meta charset="UTF-8" />
    <title>Flex cards - Stranger Things - @programador.cs</title>
    <link
      rel="stylesheet"
        ...
        <div class="options">
          ...
          <div class="option active" style="--optionBackground: url(n4.jpg)">
            ...
            <div class="label">
              ...
              <div class="info">
                <div class="main" style="color: white">Hopper</div>
          ...
          <div class="option" style="--optionBackground: url(n8.jpg)">
            ...
            <div class="label">
              ...
              <div class="info">
                <div class="main" style="color:cornsilk">Dustin</div>
                <div class="sub" style="color:cornsilk">Badda Badda BOOM!</div>
              </div>
            </div>
          </div>
        </div>
